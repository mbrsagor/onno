...
from restaurant.views.restaurant_views import RestaurantViewSet, RestaurantUsers
...
urlpatterns = [
                  ...
                  path('order-outlet-graph/', OrderOutletGraphAPIView.as_view(), name='order_outlet_graph'),
                  path('live-order/<int:id>/', LiveOrderAPIView.as_view(), name='live_order'),
                  path('restaurant-users/<subdomain>/', RestaurantUsers.as_view(), name='restaurant_users'),
              ] + router.urls
