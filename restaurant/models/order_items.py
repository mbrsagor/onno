...
from base.utils import STATUS
from base.utils import AddressType
...
class OrderItem(BaseEntity):
    ...
    item = models.ForeignKey(Inventory, on_delete=models.CASCADE, related_name='order_item')
...
class Order(models.Model):
    ...
    location = models.ForeignKey(Location, on_delete=models.CASCADE, related_name='order')
    ...
    status = models.IntegerField(choices=STATUS.get_choices(), default=STATUS.ALL.value)
